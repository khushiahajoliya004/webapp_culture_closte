    ...
    return (
      <div className="mx-auto max-w-[1310px] px-4 py-16 text-center">
        ...
        <Link href="/categories">
          <Button className="bg-[#0F4041] hover:bg-[#0a3334] rounded-none">Start Shopping</Button>
        </Link>
      </div>
    );
  }
                ...
                <div className="flex flex-col md:flex-row md:items-center gap-4">
                  ...
                  <div className="shrink-0">
                    <Link href={`/orders/${order.id}`}>
                      <Button variant="outline" size="sm" className="gap-1 rounded-none border-[#E5E7EB]">
                        Details
